...
<body>
	<?php
		...
		if(isset($_SESSION['username'])){
			...
			$sqlGet ="SELECT * from THONG_TIN where TK_EMAIL='$username'";
			$resultGet= $conn->query($sqlGet);
			// var_dump($resultGet->fetch_assoc()['TK_EMAIL']) ;
			...
			if(isset($_POST['submit'])){
				...
				if(empty($_POST['email'])){
					...
					if(filter_var($email,FILTER_VALIDATE_EMAIL)){
						...
						$errorEmail="Dia chi email khong hop le";
					}
				...
				if(empty($errorName)&& empty($errorEmail)&& empty($errorPass)){
					$sqlUpdate ="UPDATE THONG_TIN Set TEN='$name',TK_EMAIL='$email',PASS='$password' where ID='$id'  ";		
